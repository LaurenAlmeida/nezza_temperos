...
<br><br>
   ...
   <section class="py-5">
            ...
            <h5><a href="/sal" style="color:#000;">Sal</a></h5>
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                @foreach($sais as $sal)
                    <div class="col mb-5">
                        <div class="card h-100">
                            <img class="card-img-top" src=" {{ asset($sal->imagem) }}" width="255px" height="300px"/>
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">{{ $sal->nome }}</h5>
                                    <!-- Product reviews-->
                                    <!-- Product price-->
                                    {{ $sal->peso }}
                                </div>
                ...
                <h5><a href="/temperos" style="color:#000;">Tempero Completo</a></h5>
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                @foreach($temperos as $tempero)
                    <div class="col mb-5">
                        <div class="card h-100">
                            <img class="card-img-top" src=" {{ asset($tempero->imagem) }}" width="255px" height="300px"/>
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">{{ $tempero->nome }}</h5>
                                    <!-- Product reviews-->
                                    <!-- Product price-->
                                    {{ $tempero->peso }}
                                </div>
                ...
                <h5><a href="/diversos" style="color:#000;">Diversos</a></h5>
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                ...
                <h5><a href="/pimentas" style="color:#000;">Pimentas</a></h5>
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4">
                @foreach($pimentas as $pimenta)
                    <div class="col mb-5">
                        <div class="card h-100">
                            <img class="card-img-top" src=" {{ asset($pimenta->imagem) }}" width="255px" height="300px"/>
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">{{ $pimenta->nome }}</h5>
                                    <!-- Product reviews-->
                                    <!-- Product price-->
                                    {{ $pimenta->peso }}
                                </div>
